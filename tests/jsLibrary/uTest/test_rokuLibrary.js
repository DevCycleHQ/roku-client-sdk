...
describe('rokuLibrary tests', () => {
  ...
  it('test launchTheChannel success', async () => {
    nock(baseUrl).post(`/${sessionId}/launch`, requestLaunch).reply(200, respWithEmptyValue)
    const result = await library.launchTheChannel('dev', '', '')
    expect(result).to.equal(true)
  })

  it('test launchTheChannel error', async () => {
    nock(baseUrl).post(`/${sessionId}/launch`, requestLaunch).reply(500, responseWithError)
    try {
      const result = await library.launchTheChannel('dev')
  ...
  it('test sendKeypress success', async function () {
    this.timeout(4000)
    nock(baseUrl).post(`/${sessionId}/press`, requestPress).reply(200, respWithEmptyValue)
    const result = await library.sendKey('select', 0.5)
    expect(result).to.equal(true)
  })

  it('test sendKeypress error', async () => {
    nock(baseUrl).post(`/${sessionId}/press`, requestPress).reply(500, responseWithError)
    try {
      const result = await library.sendKey('select', 0.5)
      expect(result).to.not.equal(true)
    } catch (e) {
  ...
  it('test get apps success', async () => {
    nock(baseUrl).get(`/${sessionId}/apps`).reply(200, respWithApps)
  ...
  it('test get apps error', async () => {
    nock(baseUrl).get(`/${sessionId}/apps`).reply(500, responseWithError)
    try {
      const result = await library.getApps()
      expect(result).to.not.equal(true)
    } catch (e) {
  ...
  it('test verify is screen loaded success', async () => {
    nock(baseUrl).post(`/${sessionId}/element`, requestElement).reply(200, respWithElement)
  ...
  it('test verify is screen loaded error', async () => {
    nock(baseUrl).post(`/${sessionId}/element`, requestElement).reply(500, responseWithError)
    try {
      const result = await library.verifyIsScreenLoaded(
        {
          elementData: [
  ...
  it('test send keys success', async () => {
    nock(baseUrl).post(`/${sessionId}/press`, requestSequence).reply(200, respWithEmptyValue)
    const result = await library.sendKeys(['up', 'select'], 0.5)
    expect(result).to.equal(true)
  })

  it('test send keys error', async () => {
    nock(baseUrl).post(`/${sessionId}/press`, requestSequence).reply(500, responseWithError)
    try {
      const result = await library.sendKeys(['up', 'select'], 0.5)
      expect(result).to.not.equal(true)
    } catch (e) {
  ...
  it('test get elements success', async () => {
    nock(baseUrl).post(`/${sessionId}/elements`, requestElement).reply(200, respWithElements)
  ...
  it('test get elements error', async () => {
    nock(baseUrl).post(`/${sessionId}/elements`, requestElement).reply(500, responseWithError)
    try {
      const result = await library.getElements(
        {
          elementData: [
  ...
  it('test get focused element success', async () => {
    nock(baseUrl).post(`/${sessionId}/element/active`).reply(200, respWithElement)
  ...
  it('test verify is channel loaded success', async () => {
    nock(baseUrl).get(`/${sessionId}/current_app`).reply(200, respWithApp)
    const result = await library.verifyIsChannelLoaded('id')
    expect(result).to.equal(true)
  })

  it('test verify is channel loaded error', async () => {
    nock(baseUrl).get(`/${sessionId}/current_app`).reply(500, responseWithError)
    try {
      const result = await library.verifyIsChannelLoaded('id')
      expect(result).to.not.equal(true)
    } catch (e) {
  ...
  it('test get device info success', async () => {
    nock(baseUrl).get(`/${sessionId}`).reply(200, respWithDeviceInfo)
  ...
  it('test get device info error', async () => {
    nock(baseUrl).get(`/${sessionId}`).reply(500, responseWithError)
    try {
  ...
  it('test get player success', async () => {
    nock(baseUrl).get(`/${sessionId}/player`).reply(200, respWithPlayerInfo)
    const result = await library.getPlayerInfo()
    expect(result.Position).to.equal(1000)
  })

  it('test get player error', async () => {
    nock(baseUrl).get(`/${sessionId}/player`).reply(500, responseWithError)
    try {
  ...
  it('test send input data success', async () => {
    nock(baseUrl).post(`/${sessionId}/input`).reply(200, respWithEmptyValue)
    const result = await library.inputDeepLinkingData('dev', '12', 'movie')
    expect(result).to.equal(true)
  })

  it('test send input data error', async () => {
    nock(baseUrl).post(`/${sessionId}/input`).reply(500, responseWithError)
    try {
      const result = await library.inputDeepLinkingData('dev', '12', 'movie')
      expect(result).to.not.equal(true)
    } catch (e) {
